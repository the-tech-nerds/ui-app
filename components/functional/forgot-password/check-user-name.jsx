            ...
            <div className="form-row">
                <div className="col-md-12">
                    <input type="text" className="form-control" id="username"
                        ref={register({ required: true})}   placeholder="enter your phone or email" required="" name="username" />
                 {errors.username && <span style={error}>please input phone or email</span>}
                </div>
