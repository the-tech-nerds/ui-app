                    ...
                    {serverError.error && <AlertMessage className = "alert alert-danger alert-dismissible">{serverError.error}</AlertMessage>}
                        <form className="theme-form"  onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-row">
                                {userInfo.has_password && <div className="col-md-12">
                                    ...
                                    {errors.old_password && <span style={error}>{errors.old_password.message}</span>}
                                </div>}
                            </div>
                            <div className="form-row">
                                <div className="col-md-12">
                                    ...
                                    {errors.new_password && <span style={error}>{errors.new_password.message}</span>}
                                </div>
                            </div>
                            <div className="form-row">
                                <div className="col-md-12">
                                    ...
                                    {errors.new_password_confirm && <span style={error}>{errors.new_password_confirm.message}</span>}
                                </div>
