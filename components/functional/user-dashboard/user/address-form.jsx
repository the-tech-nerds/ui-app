                        ...
                        <form className="theme-form"  onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-row">
                                <div className="col-md-6">
                                    ...
                                    <input type="text" ref={register({ required: true })} className="form-control" id="name"
                                           name="name"  placeholder="Enter your first and last name. Example: Asif Ahmed"/>
                                    {errors.name && <span style={error}>Name is required</span>}
                                </div>
                                <div className="col-md-6">
                                    <label htmlFor="Address">Address</label>
                                    <input type="text"
                                           name="details" className="form-control" id="details" ref={register({ required: true })}
                                           placeholder="For Example: House# 123, Street# 123, ABC Road" required="" />
                                    {errors.details && <span style={error}>Details is required</span>}
                                </div>
                            </div>
                            <div className="form-row">
                                <div className="col-md-6">
                                    <label htmlFor="Division">Division</label>
                                    <select name="division_id"  className="form-control select-dropdown" ref={register ({required: true})}>
                                        {divisions}
                                    </select>
                                    {errors.division_id && <span style={error}>Division is required</span>}
                                </div>
                                <div className="col-md-6">
                                    <label htmlFor="City">City</label>
                                    <select name="city_id" className="form-control select-dropdown"  ref={register ({required: true})}>
                                        {cities}
                                    </select>
                                    {errors.city_id && <span style={error}>City is required</span>}
                                </div>
                            ...
                            <div className="form-row">
                                <div className="col-md-6">
                                    ...
                                    <select name="area_id" className="form-control select-dropdown" ref={register ({required: true})}>
                                        {areas}
                                    </select>
                                    {errors.area_id && <span style={error}>Area is required</span>}
                                </div>
                                <div className="col-md-6">
                                    <label htmlFor="PostCode">Post Code</label>
                                    <input type="number" name="postcode"  className="form-control" id="postcode"
                                           ref={register}   placeholder="postcode" required="" />
                                </div>
                            </div>
                            <div className="form-row">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <input type="text" name="contact_no"  className="form-control" id="contact_no"
                                           ref={register({ minLength: 11 })}   placeholder="Please enter your phone number"  />
                                    {errors.contact_no && <span style={error}>Phone number is required</span>}
                                </div>
                                <div className="col-md-6">
